...
<div class="" style="font-size: 16px">
    <form class="layui-form" action="" method="post">
            {{csrf_field()}}
        <input type="text" value="instagram" name="model" hidden>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <span style="line-height: 38px;color: red">{{$msg->ScriptInfo->rate}} 元/天</span>
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input name="machine_code" hidden value="{{$msg->machine_code}}">
        ...
        form.on('submit(chargeForm)', function(data){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    {
                        $.message('成功');
                        window.setTimeout("location.href='/admin/instagram'",3000);
                    }
                    if(data[0]['code'] == 201)
                    {
                        $.message({
