    ...
    <div class="" style="font-size: 16px">
        <form class="layui-form" action="" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input value="{{$mc->terminology}}" readonly disabled type="text" name="terminology" placeholder="请填写发送的话术语句" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">间隔时间</label>
                <div class="layui-input-block">
                    <input value="{{$mc->interval_time}}" readonly disabled type="text" name="intervalTime" placeholder="请填写间隔时间(秒)" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
